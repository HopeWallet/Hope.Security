...
namespace Hope.Security.Encryption.PBKDF2
{
    ...
    /// </summary>
    public abstract class PBKDF2PasswordHashing
    {
        ...
        /// <summary>
        /// The digest used for hashing the password.
        /// </summary>
        protected abstract IDigest PBKDF2Digest { get; }
        ...
        {
            byte[] salt = new AdvancedSecureRandom(PBKDF2Digest).NextBytes(saltSize <= MIN_SALT_SIZE ? MIN_SALT_SIZE : saltSize);
        ...
        {
            var generator = new Pkcs5S2ParametersGenerator(PBKDF2Digest);
